...
namespace T4MVCHostMvc5App.Areas.Break.Controllers
{
    public partial class RouteController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected RouteController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public RouteController Actions { get { return MVC.@break.Route; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "break";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Route";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Route";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_RouteController : T4MVCHostMvc5App.Areas.Break.Controllers.RouteController
    {
        public T4MVC_RouteController() : base(Dummy.Instance) { }
