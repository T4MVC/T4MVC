...
namespace T4MVCHostMvc5App.Areas.Break.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PostController : T4MVCHostMvc5App.Areas.Break.Controllers.PostController
    {
        ...
        [NonAction]
        partial void ActionThatTakesAnObjectOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, T4MVCHostMvc5App.Areas.Break.Controllers.MyParamObject p);

        [NonAction]
        public override System.Web.Mvc.ActionResult ActionThatTakesAnObject(T4MVCHostMvc5App.Areas.Break.Controllers.MyParamObject p)
        {
