...
namespace T4MVCHostMvc5App.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : T4MVCHostMvc5App.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void SomeCustomResultActionOverride(T4MVC_T4MVCHostMvc5App_Misc_MyCustomResult callInfo);

        [NonAction]
        public override T4MVCHostMvc5App.Misc.MyCustomResult SomeCustomResultAction()
        {
            var callInfo = new T4MVC_T4MVCHostMvc5App_Misc_MyCustomResult(Area, Name, ActionNames.SomeCustomResultAction);
        ...
        [NonAction]
        partial void ActionReturningGenericResultStringOverride(T4MVC_T4MVCHostMvc5App_Controllers_SomeGenericResult_System_String callInfo);

        [NonAction]
        public override T4MVCHostMvc5App.Controllers.SomeGenericResult<System.String> ActionReturningGenericResultString()
        {
            var callInfo = new T4MVC_T4MVCHostMvc5App_Controllers_SomeGenericResult_System_String(Area, Name, ActionNames.ActionReturningGenericResultString);
            ActionReturningGenericResultStringOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void ActionReturningGenericResultIntOverride(T4MVC_T4MVCHostMvc5App_Controllers_SomeGenericResult_System_Int32 callInfo);

        [NonAction]
        public override T4MVCHostMvc5App.Controllers.SomeGenericResult<System.Int32> ActionReturningGenericResultInt()
        {
            var callInfo = new T4MVC_T4MVCHostMvc5App_Controllers_SomeGenericResult_System_Int32(Area, Name, ActionNames.ActionReturningGenericResultInt);
            ActionReturningGenericResultIntOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void ActionReturningGenericResultNestedOverride(T4MVC_T4MVCHostMvc5App_Controllers_SomeGenericResult_System_Collections_Generic_List_System_Tuple_System_String_System_String_System_Int32 callInfo);

        [NonAction]
        public override T4MVCHostMvc5App.Controllers.SomeGenericResult<System.Collections.Generic.List<System.Tuple<System.String, System.String, System.Int32>>> ActionReturningGenericResultNested()
        {
            var callInfo = new T4MVC_T4MVCHostMvc5App_Controllers_SomeGenericResult_System_Collections_Generic_List_System_Tuple_System_String_System_String_System_Int32(Area, Name, ActionNames.ActionReturningGenericResultNested);
