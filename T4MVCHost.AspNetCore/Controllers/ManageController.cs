...
using T4MVCHost.AspNetCore.Models;
using T4MVCHost.AspNetCore.Services;
using T4MVCHost.AspNetCore.ViewModels.Manage;
...
namespace T4MVCHost.AspNetCore.Controllers
{
    ...
    public partial class ManageController : Controller
    {
        ...
        // GET: /Manage/Index
        [HttpGet]
        public virtual async Task<IActionResult> Index(ManageMessageId? message = null)
        {
        ...
        public virtual async Task<IActionResult> RemoveLogin(RemoveLoginViewModel account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual async Task<IActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
        ...
        [HttpGet]
        public virtual async Task<IActionResult> VerifyPhoneNumber(string phoneNumber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual async Task<IActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [HttpGet]
        public virtual async Task<IActionResult> ManageLogins(ManageMessageId? message = null)
        {
            ViewData["StatusMessage"] =
