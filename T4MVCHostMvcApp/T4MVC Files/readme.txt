...
!!! 3.5.x (2-22-2013):
* If static files include a timestamp, previously for minified CSS- and JavaScript-files the timestamp was generated by taking the last change time of the unminified file.
