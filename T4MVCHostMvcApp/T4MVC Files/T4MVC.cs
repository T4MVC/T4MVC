...
public static partial class MVC
{
    ...
    public static T4MVCHostMvcApp.Controllers.TestAttribute_YES_Name1Controller TestAttribute_YES_Name1 = new T4MVCHostMvcApp.Controllers.T4MVC_TestAttribute_YES_Name1Controller();
    public static T4MVCHostMvcApp.Controllers.TestAttribute_YES_ControllerName3 TestAttribute_YES_Name3 = new T4MVCHostMvcApp.Controllers.T4MVC_TestAttribute_YES_ControllerName3();
    public static T4MVCHostMvcApp.Controllers.TestAttribute_YES_Processed1Controller TestAttribute_YES_Processed1 = new T4MVCHostMvcApp.Controllers.T4MVC_TestAttribute_YES_Processed1Controller();
    public static T4MVCHostMvcApp.Controllers.TestAttribute_YES_Processed2Controller TestAttribute_YES_Processed2 = new T4MVCHostMvcApp.Controllers.T4MVC_TestAttribute_YES_Processed2Controller();
    public static T4MVCHostMvcApp.Controllers.TestAttribute_YES_Abstract2Controller TestAttribute_YES_Abstract2 = new T4MVCHostMvcApp.Controllers.T4MVC_TestAttribute_YES_Abstract2Controller();
    public static T4MVCHostMvcApp.Controllers.TestAttribute_YES_DerivedController TestAttribute_YES_Derived = new T4MVCHostMvcApp.Controllers.T4MVC_TestAttribute_YES_DerivedController();
