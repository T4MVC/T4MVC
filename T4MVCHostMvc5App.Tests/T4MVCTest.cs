...
using T4MVCHostMvc5App.Controllers;
...
namespace T4MVCHostMvc5App.Tests
{
    ...
    public class T4MVCTest
    {
        ...
        public void TestAreaActionName()
        {
            ...
            TestAreaControllerActionName( "The Index", T4MVCHostMvc5App.Areas.Home.Controllers.HomeController.ActionNameConstants.Index );
        }
        ...
        {
            Assert.AreEqual( "~/Views/Home/Index.cshtml", MVC.Home.Views.Index );
        ...
        {
            Assert.AreEqual( "~/Views/Shared/_LogOnUserControl.cshtml", MVC.Shared.Views._LogOnUserControl );
            Assert.AreEqual( "_LogOnUserControl", MVC.Shared.Views.ViewNames._LogOnUserControl );
        }
        ...
        {
            var controller = new T4MVCHostMvc5App.Controllers.HomeController();
        ...
        {
            Assert.AreEqual( "/Scripts/jquery-1.10.2.js", Links.Scripts.jquery_1_10_2_js );
        }

        [TestMethod()]
        public void TestCssFile()
        {
            Assert.AreEqual( "/Content/Site.css", Links.Content.Site_css );
        }
